...
public class ComponentisedGraphGenerator {

	Random _rnd;
	
	public ComponentisedGraphGenerator() {
		_rnd = new Random();
	}
	
	public ComponentisedGraphGenerator(long seed) {
		_rnd = new Random();
		_rnd.setSeed(seed);
	}
	
	public ComponentisedGraph GenerateTotalGraph(int nodes, int minEdgeWeight, int maxEdgeWeight) {
		ComponentisedGraph G = new ComponentisedGraph();
    ...
    public ComponentisedGraph GenerateGridGraph(int rows, int columns, int minEdgeWeight, int maxEdgeWeight) {
