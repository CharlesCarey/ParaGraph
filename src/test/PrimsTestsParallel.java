...
public class PrimsTestsParallel {
	...
	public void testCorrectPrimsTreeWeight() {
        BasicUndirectedGraph<BasicVertex, BasicSimpleEdge<BasicVertex>> mst = new PrimsAlgorithmParallel().Run(_inputGraph);
	...
	public void testCorrectPrimsTreeWeightWithOneNode() {
        BasicUndirectedGraph<BasicVertex, BasicSimpleEdge<BasicVertex>> mst = new PrimsAlgorithmParallel().Run(_inputGraph1Node);
        int minTotalWeight = 0;
        for(BasicSimpleEdge e : mst.edges()) {
            minTotalWeight += e.weight();
        }
	...
	public void testEmptyInputGraph() {
        BasicUndirectedGraph<BasicVertex, BasicSimpleEdge<BasicVertex>> mst = new PrimsAlgorithmParallel().Run(_emptyGraph);
